...
| [`spring-best-practice-review`](skills/spring-best-practice-review/) | Spring 소스, 설정, 아키텍처, 의존성, 보안, 데이터, 메시징, 운영의 종합 또는 집중 정적 검토 | 근거와 우선순위를 포함한 발견 사항 및 개선안 |
...
spring-best-practice-review로 이 Spring 서비스의 운영 준비 상태를 검토해줘.
