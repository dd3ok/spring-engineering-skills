...
2. Verify the requested version line and system requirements before generating files. If the target is floating or incompatible, stop and surface the decision instead of guessing.
