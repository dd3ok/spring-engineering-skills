...
- Note that Spring Authorization Server moved into Spring Security 7.0 and standalone 1.5.x is its last generation. Verify the target line before recommending new development.
