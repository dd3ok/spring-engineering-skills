# Specialized Spring Official Sources

Checked on: 2026-07-13. Use this map for discovery, then cite the exact versioned page used. Re-check current pages and label non-GA sources.
...
- Spring Security authorization-server reference for Spring Security 7+: https://docs.spring.io/spring-security/reference/servlet/oauth2/authorization-server/index.html
