...
- Projects in the Attic list: https://spring.io/projects/#projects-in-the-attic
...
- Spring Boot 4.1 release notes, including the `InetAddressFilter` introduction: https://github.com/spring-projects/spring-boot/wiki/Spring-Boot-4.1-Release-Notes
...
- Application availability and lifecycle events: https://docs.spring.io/spring-boot/reference/features/spring-application.html
...
- Current Spring Boot `InetAddressFilter` API; use versioned evidence for a deployed older line: https://docs.spring.io/spring-boot/api/java/org/springframework/boot/http/client/InetAddressFilter.html
...
- Declarative transaction internals and reactive context: https://docs.spring.io/spring-framework/reference/data-access/transaction/declarative/tx-decl-explained.html
...
- Spring Cloud Vault Config: https://docs.spring.io/spring-cloud-vault/reference/

## Spring Security

- Security reference index: https://docs.spring.io/spring-security/reference/index.html
- Current Spring Security changes: https://docs.spring.io/spring-security/reference/whats-new.html
...
- Spring Security 7.0 changes and removals: https://docs.spring.io/spring-security/reference/7.0/whats-new.html
