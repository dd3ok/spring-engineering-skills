...
- Job configuration and running jobs: https://docs.spring.io/spring-batch/reference/job.html
...
- Spring Kafka listener annotations and batch listeners: https://docs.spring.io/spring-kafka/reference/kafka/receiving-messages/listener-annotation.html
...
- Micrometer observation instrumentation: https://docs.micrometer.io/micrometer/reference/observation/instrumenting.html
