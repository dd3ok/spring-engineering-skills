...
- Use `review-rules.md` for baseline JPA, JDBC, and R2DBC selection.
...
- Verify code generation source, migration ordering, generated-source check-in policy, dialect, naming strategy, and regeneration in CI.
...
- jOOQ generated classes drifting from the migrated schema.
- NoSQL chosen only to avoid schema design, indexes, or transaction modeling.
- Spring Data REST exposing repositories without explicit authorization and projection review.
